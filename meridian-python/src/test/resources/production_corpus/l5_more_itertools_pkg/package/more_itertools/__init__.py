# L5 facade — mirrors more_itertools/__init__.py re-exports (hot subset).
from .recipes import (
...
from .more import chunked, first, last, ilen, one, windowed, intersperse

# Bench wrappers (JSON-comparable)
...
def windowed_lens(seq, n):
    return [len(w) for w in windowed(seq, n)]
